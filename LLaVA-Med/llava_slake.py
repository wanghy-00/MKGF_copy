...
with open(f"../dataest/SLAKE/slake_rationale.json", "r", encoding='utf-8') as f1:
    data = json.load(f1)
...
for line in tqdm(data):
    ...
    if answer_type == 'OPEN':
        cur_prompt = (
            ...
            + retrieved_chunks +  
            "\nPlease provide a detailed, thorough, and comprehensive answer to the following question.Please consider the following three points:\n"
            "1.Organs such as Head,Chest,Lung,Abdomen and Liver."
            "2.Position of the organ such as Lung, Lung or Center."
            "3.Color of the organ such as Black or White."
