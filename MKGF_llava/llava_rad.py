...
for qid in tqdm(range(len(questions))):
    ...
    if ans.lower() == "yes" or ans.lower() == "no":
        cur_prompt = (
            ...
            + retrieved_chunks +  
            "If you can not give a certain answer according to the retrieved medical knowledge, just return 'no'.\n"
            "Question: " + question
        )
        ...
        cur_prompt = (
            "You are an expert in medical imaging with extensive knowledge in interpreting imaging results and understanding related medical concepts. The following retrieved medical knowledge might be helpful: \n"
            + retrieved_chunks +  
            "The above reference information may be useful or it may not be useful.Please provide a thorough, well-reasoned answer, considering axial image, and give a detailed explanation to your answer.\n"
            "Question: " + question 
        )
...
with open('llava_rad.json', 'w', encoding='utf-8') as f:
