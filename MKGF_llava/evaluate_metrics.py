...
#     candidate_answers = candidate_set['0']['value']
...
def calculate_appearance_with_normalization(prediction, reference, candidate_set):
    ...
    # 确保 candidate_set 是字典并访问候选答案列表
    if isinstance(candidate_set, dict) and '0' in candidate_set and 'value' in candidate_set['0']:
        candidate_answers = candidate_set['0']['value']
    else:
        return 0.0  # 或根据你的需求返回默认值
